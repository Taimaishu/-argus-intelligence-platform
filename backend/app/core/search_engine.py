...
class SearchEngine:
    ...
    def get_similar_chunks(
        ...
        if not chunk or not chunk.embedding_id:
            logger.warning(f"Chunk not found or no embedding: doc={document_id}, idx={chunk_index}")
            return []
    ...
    def get_document_summary(
        ...
        return {
            ...
            "embedding_coverage": round(embedded_count / chunk_count * 100, 2) if chunk_count > 0 else 0
        }
